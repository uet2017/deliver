            ...
            <div class="contact-grids">
                <div class="contact-right">
                    ...
                    <form name="register" id="register" method="post" action="editprof.php">
                        <div>
                            <span>Name</span>
                            <input type="text" name="name" maxlength="30" value=<?php 
                                $un=$_SESSION['empusername'];
                                $query="select * from employee where username='$un'";
                                $query_run=mysqli_query($con,$query);
                                $row = mysqli_fetch_array($query_run);
                        ...
                        <div>
                            ...
                            <textarea name="addr" maxlength="100" cols="5" placeholder=<?php 
                                ...
                                echo '"'.$row['address'].'"';
                                ?>></textarea>         
                        <input type="submit" Value="Save" name="save_submit" class = "sub"/>
                        <br>
                    </form>                
                    <?php 
                        ...
                        {   
                            ...
                            if($password==$cpassword){  
                                ...
                                $email=$_POST['email'];  
                                $addr = $_POST['addr'];                               
                                $query="update employee set name = '$name', phone = '$phone', email = '$email', password = '$password', address = '$addr' where username = '$un'";                       
                                $query_run=mysqli_query($con,$query);
                                if($query_run)
