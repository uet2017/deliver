				...
				<div class="about-grids-row1">
					<div class="col-lg-12">
                        ...
                        <tr class="bg-dark text-white text-center">
                            ...
                            <th><center> From district </center></th>
                            <th><center> Address detail </center></th>
                            <th><center> To District </center></th>
                            <th><center> Address detail </center></th>
                            <th><center> Speed </center></th>
                            <th><center> Order Date </center></th>
                            <th><center> status </center></th>
                            <th><center> Cost </center></th>                            
							<th><center> employ_id</center></th>
							<th><center> Edit status</center></th>
							<th><center> Delete order</center></th>
                        </tr > 
                        <?php                
                    ...
                    <tr class="text-center">
                        ...
                        <td> <button class="btn btn-success"> <a href="orderedit.php?id=<?php echo $row['order_code']; ?>" class="text-white"> Edit </a>  </button> </td>
						<td> <button class="btn btn-danger"> <a href="orderdel.php?id=<?php echo $row['order_code']; ?>" class="text-white"> Delete </a>  </button> </td>
                    </tr>
                    <?php 
                        } 
                        ?>               
