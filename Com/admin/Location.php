		...
		<div class="container">   
			<div class="about-grids">
				<div class="about-grids-row1">
					<div class="col-lg-12">
						<h1 class="text-warning text-center" > List of district </h1>
						<button class="btn btn-info"> <a href="index.php" class="text-white"> Go Back </a>  </button>
						<br>
						<table  id="tabledata" class=" table table-striped table-hover table-bordered">
							<tr class="bg-dark text-white text-center">
								<th> <center>locate ID</center> </th>
								<th> <center>locate name</center></th>
						...
						<tr class="text-center">
							...
							<td> <button class="btn btn-danger"> <a href="localdelete.php?id=<?php echo $row['id']; ?>" class="text-white"> delete </a>  </button> </td>
						</tr>
						<?php 
							} 
							?>               
						</table>
						<button class="btn btn-info"> <a href="localadd.php" class="text-white"> Add </a>  </button>
					</div>
				</div>
			</div>   
		</div>
