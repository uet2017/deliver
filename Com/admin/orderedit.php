    ...
    <div class="container">
        <div class="about-grids">
            ...
            <div id="abc">
	                    ...
	                    <form class="myform" action="orderedit.php?id=<?php echo $row['order_code']; ?>" method="post">
                            <span>send from : </span>
                            <label>
                                <?php
                                    $id = $_GET['id'];
                            ...
                            <span>status</span>
                            <br>
                                <textarea name="sta" maxlength="100" cols="5" style="width: 100%;"placeholder=""></textarea>
                            <br>                   
                            <span>cost</span>
                            <br>
                                <textarea name="cost" maxlength="100" cols="5" style="width: 100%;"placeholder=""></textarea>
                            <br>
                    ...
                    <?php 
                        ...
                        {                       
                            ...
                            $status = $_POST['sta'];  
                            $cost = $_POST['cost'];          
                            $query2 = "update orders set status = '$status', cost = '$cost' where order_code = '$id'";
