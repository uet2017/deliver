				...
				<div class="about-grids-row1">
					<div class="col-lg-12">
						...
						<tr class="text-center">
                            ...
                            <td> <button class="btn btn-success"> <a href="verify.php?id=<?php echo $row['employ_id']; ?>" class="text-white"> success </a>  </button> </td>
							<td> <button class="btn btn-danger"> <a href="deleteverf.php?id=<?php echo $row['employ_id']; ?>" class="text-white"> delete </a>  </button> </td>
						</tr>
						<?php 
							} 
							?>               
