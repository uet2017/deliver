        ...
        <div class="container">       
            <div class="about-grids">
                <div class="about-grids-row1">
                    <div id="abc">
	                    <center><h2>Request Transport</h2></center>
                        <center><img class="avatar" src="../images/avatar.jpg"></center>
	                    <form class="myform" action="addorder.php" method="post">
                            <span>send from</span>
                            ...
                            <br>
                                <textarea name="addr_f" maxlength="100" cols="5" style="width: 100%;"></textarea>
                            <br>
                            <span>To</span>
                            ...
                            <span>Address detail</span>
                            <br>
                                <textarea name="addr_t" maxlength="100" cols="5" style="width: 100%;"></textarea>
                            <br>
                            ...
                            <br>
                                <textarea name="pck_d" maxlength="100" cols="5" style="width: 100%;"></textarea>
                            <br>                   
                            <input type="submit" name="submit_button" id="register-button" value="Tạo đơn" />
                    ...
                    <?php 
                        ...
                        {                       
                            ...
                            $speed = $_POST['dspeed'];
                            $pdetail = $_POST['pck_d'];                  
                            $query2 = "insert into orders (customer_id, speed, adrfrom, adr_from_detail, adrto,adr_to_detail, pack_detail) values ('$cusid','$speed','$from','$fdetail','$to','$tdetail','$pdetail')" ;
                            $query_run2 = mysqli_query($con,$query2);
                            if($query_run2)
                                echo '<script type="text/javascript"> alert("don hang duoc tao thanh cong") </script>';       
                            else
